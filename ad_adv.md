...
시작 부분에 x 문자가 없기 (0개) 때문에 일치해서 y 로 변환되고, a 문자를 출력하고, 다시 b 도 x 가
...
조각으로 저장한 다음, 조각을 대체 문자열에서 재정렬해서 출력하는 것입니다. 대체 명령의 검색
...
...fixed up line...
‘‘a’’, ‘‘i’’ 또는 ‘‘c’’ 명령에 아무런 텍스트를 입력하지 않았을 때, 현재 주소가 어떻게 설정되는지
실험해보시기 바랍니다.
...
때문입니다. 이런 처리 특성은 매우 간단한 상황에서 가장 자주 사용합니다. 예를 들어, thing 문자열이
...
출력합니다.
이 명령은 파일을 두 단계로 나눠서 처리합니다. 첫 번째 패스에서는 검색 문자열 패턴과 일치한 모든
...
.r table
여기서의 가장 핵심 사항은 마지막에 사용한 명령입니다. 앞에서 설명했듯이 ‘‘r’’ 명령은 파일을
...
기호입니다.
7.2. Editing Scripts
전체 파일 집합에 대해서 상당히 복잡한 편집 작업을 수행할 경우, 가장 쉬운 처리 방법은 수행하려는
작업 명령이 포함된 파일인 ‘‘스크립트’’ 를 만든 다음, 이 스크립트를 대상 파일에 적용해서 일괄적으로
처리하는 방법입니다. 예를 들어, 수 많은 파일에 포함된 Unix 문자열 패턴을 UNIX 로 변경하고, 모든
Gcos 문자열 패턴을 GCOS 문자열로 변경한다고 가정합니다. 먼저 다음과 같은 ‘‘스크립트 명령 파일’’
을 작성합니다.
ed scripts
g/Unix/s//UNIX/g
g/Gcos/s//GCOS/g
...
ed file2 <scripts
...
ed는 준비된 스크립트 명령 파일에서 명령을 순차적으로 실행해서 처리합니다. 처리할 전체 작업을
미리 계획해서 작성해야 합니다.
물론, UNIX의 쉘 스크립트 반복문과 함께 사용한다면 파일 세트를 자동으로 순환하면서 모두 처리할 수
있습니다. (for..in...do...done)
7.3. sed
‘‘sed’’ (Stream Editor) 는 대화식 편집 기능이 제한된 비대화식 편집기 버전이지만, 무제한의 입력을
처리할 수 있고, 필터 프로그램으로 사용할 수 있는 장점이 있습니다. 기본적으로 sed는 각 입력 라인에
하나 이상의 편집 명령을 적용해서 처리하고 입력을 출력에 복사합니다. 예를 들어, Unix 문자열 패턴을
UNIX 로 변경할 때, 파일로 결과를 저장하지 않고, 표준 출력으로만 출력합니다. 다음과 같은 명령을
실행합니다.
sed ’s/Unix/UNIX/g’ file1 file2 ...
‘‘s/Unix/UNIX/g’’ 명령을 file1, file2 등의 파일의 모든 라인에 적용하고, 적용된 모든 라인을 표준
출력에 복사합니다. ed 편집기보다 sed 편집기를 사용할 때의 장점은 ed가 처리하기에 너무 큰 입력
파일도 처리할 수 있다는 것입니다. 모든 출력은 입출력 재지정 (>) 문자로 별도의 파일에 저장하거나,
다른 프로그램으로 파이프 ( | ) 를 통해서 전달할 수 있습니다.
편집 변환 작업이 너무 복잡해서 둘 이상의 편집 명령을 사용할 경우, 명령을 스크립트 파일이나 또는
명령 라인에서도 더 복잡한 구문을 사용해서 처리할 수 있습니다. 예를 들어, 다음과 같이 cmdfile 에
편집 명령을 저장한 후 실행할 수 있습니다.
sed -f cmdfile input-files ...
sed는 조건부 테스트와 분기 명령을 포함해서 여기서 모두 설명하지 못하는 수 많은 추가적인 기능을
갖고있는 강력한 비대화식 편집기입니다.
7.4. Acknowledgement
...
Table of Contents
1. Introduction . . . . . . . . . . . . . . . . . . . . . . . . . 1
