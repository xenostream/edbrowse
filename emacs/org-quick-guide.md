...
<br><br>
# 1 Introduction
“Org 모드” 는 빠르고 효율적인 순수 텍스트 시스템으로 메모를 작성하거나 할 일 목록을 관리하고 프로젝트의 계획을 세울 수 있는 메이저 모드(major mode)입니다. 또한 문서 작성 및 출판 시스템이며 리터러시 프로그래밍과 재현 가능한 연구를 위한 소스 코드 작업도 지원합니다.
